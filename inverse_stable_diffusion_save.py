...
class InversableStableDiffusionPipeline(ModifiedStableDiffusionPipeline):
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            for i, t in enumerate(self.progress_bar(timesteps_tensor)):
                ...
                # Algorithm 1
                if (i==0 and inv_order ==2) or inv_order == 1:
                    ...
                    with torch.no_grad():
                        if (i + 1 < len(timesteps_tensor)):
                            ...
                            for step in range(i, i+2, 1):
                                ...
                                y = (sigma_s / sigma_t * y + sigma_s / sigma_t * alpha_t * phi_1 * model_s) #DPMsolver++
    ...
    def differential_correction(self, x, s, t, x_t, r=None, order=1, use_float=False, n_iter=200, lr=0.1, th=1e-6, model_s_output=None, model_r_output=None, text_embeddings=None):
        if order==1:
            import copy
